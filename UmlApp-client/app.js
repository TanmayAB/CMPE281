...
app.post('/grade',function(req,res){
	...
	console.log('inside grade API');
		...
		if(tenant === "t001"){
			...
			connection.query("INSERT INTO TENANT3_H(SCORE) VALUES ('"+score+"')", function (error, results, fields) {
					if (error) throw error;
					else{
			...
			connection.query("INSERT INTO TENANT4_U(STATUS,REMARKS) VALUES ('"+status+"','"+remarks4+"')", function (error, results, fields) {
					if (error) throw error;
					else{
